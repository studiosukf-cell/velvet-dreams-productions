      ...
      <section className="section-padding !pt-0">
        <div className="container max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
            <a
              href="mailto:info@eliteframe.co.uk"
            ...
            <div className="glass-card rounded-lg p-6 text-center hover-lift">
              <div className="w-14 h-14 rounded-full bg-accent/30 flex items-center justify-center mx-auto mb-4">
                <MapPin size={22} className="text-deep-red-light" />
              </div>
          ...
          <div className="glass-card rounded-xl p-8 md:p-12 max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Input placeholder="Subject" required className="bg-background/50 border-border" />
              <Textarea placeholder="Your Message" required className="bg-background/50 border-border min-h-[120px]" />
              <Button
                type="submit"
                disabled={submitting}
