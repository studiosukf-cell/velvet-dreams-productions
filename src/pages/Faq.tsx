...
const faqs = [
  ...
  { q: "What is the pay like?", a: "Male performers earn £1,500 per day and female performers earn £2,250 per day. Studio managers can earn competitive salaries based on experience and studio performance." },
  ...
  { q: "Can I work with Hussy remotely?", a: "Yes, we offer opportunities for remote work, including cam modeling and online brand building. You can collaborate with our team to create content from the comfort of your own space." },
];
        ...
        <AnimatedSection delay={0.4}>
          <div className="text-center mt-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact"><Button variant="outline" className="border-gold/40 text-gold hover:bg-gold/10">Contact Us</Button></Link>
              <Link to="/join"><Button className="gradient-gold-bg text-primary-foreground font-bold glow-gold hover:opacity-90">Apply Now</Button></Link>
            </div>
          </div>
        </AnimatedSection>
      </div>
